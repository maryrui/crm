<template>
  <div v-loading="loading"
    ...
    <div class="content">
      <div class="content-title">签约订单数排行（按实际签订时间）</div>
      ...
      <div class="table-content">
        <el-button :loading="downloadLoading" style="margin:10px 0 10px 0;" type="primary" icon="el-icon-document" @click="handleDownload(fieldList, list, '签约订单排行')">
          导出
        </el-button>
        <el-table :data="list"
                  height="400"
